...
export function ForgotPasswordPage() {
  ...
  return (
    <div className="relative flex flex-col w-full min-h-screen font-body-md text-slate-800 overflow-hidden bg-slate-50">
      ...
      {/* Ambient Background Blobs matched with MSSC theme */}
      <div className="absolute top-[-10%] left-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#00476D]/10 to-[#0076b6]/5 blur-[80px] pointer-events-none animate-[pulse_8s_infinite_alternate]"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#0076b6]/10 to-[#00476D]/5 blur-[80px] pointer-events-none delay-500 animate-[pulse_8s_infinite_alternate]"></div>
        ...
        <div className="w-full max-w-[480px]">
          <div className="bg-white/95 backdrop-blur-xl shadow-xl border border-slate-200/50 rounded-[2rem] px-8 py-12 md:px-14 md:py-16">
            ...
            {!isSubmitted ? (
              <>
                <div className="flex justify-center mb-8">
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-[#0076b6]/10 text-[#0076b6]">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-6 py-2.5 bg-slate-50 border border-slate-200 rounded-full focus:ring-2 focus:ring-[#0076b6]/20 focus:border-[#0076b6] transition-all outline-none text-slate-900 placeholder-slate-400/70 [&:-webkit-autofill]:shadow-[0_0_0_1000px_white_inset]"
                      />
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-[#00476D] to-[#0076b6] text-white py-4 rounded-full font-label-md text-[14px] font-bold shadow-lg shadow-[#0076b6]/30 hover:shadow-[#0076b6]/50 hover:-translate-y-0.5 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-14 py-2.5 bg-slate-50 border border-slate-200 rounded-full focus:ring-2 focus:ring-[#0076b6]/20 focus:border-[#0076b6] transition-all outline-none text-slate-900 placeholder-slate-400/70 [&:-webkit-autofill]:shadow-[0_0_0_1000px_white_inset]"
                      />
                      <button 
                        type="button" 
                        onClick={() => setShowNewPassword(!showNewPassword)}
                        className="absolute inset-y-0 right-0 pr-5 flex items-center text-slate-400 hover:text-[#0076b6] transition-colors"
                      >
              ...
              <div className="space-y-8 text-center animate-[fadeIn_0.3s_ease-out]">
                <div className="flex justify-center">
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-slate-100 text-[#0076b6]">
                    <CheckCircle2 className="w-12 h-12 stroke-[1.5]" />
                  </div>
                </div>
                <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-left flex items-start gap-4">
                  <div className="p-1 mt-0.5 rounded-md bg-white text-[#0076b6] shadow-sm border border-slate-100">
                    <LockKeyhole className="w-4 h-4" />
                  </div>
                  <div>
                    <h3 className="font-label-md text-[14px] font-bold text-[#00476D] mb-1">
            ...
            <div className="mt-4 pt-4 border-t border-slate-200 text-center">
              <Link
                to="/login"
                className="inline-flex items-center gap-2 text-[#0076b6] font-label-md text-[14px] font-bold hover:underline decoration-2 underline-offset-4 group"
              >
...
export function LoginPage() {
  ...
  return (
    <div className="relative flex flex-col w-full min-h-screen font-body-md text-slate-800 overflow-x-hidden bg-gradient-to-br from-slate-900 to-[#00476D]">
      ...
      {/* Full-page blue overlay wrapper */}
      <div className="absolute inset-0 bg-gradient-to-br from-slate-950/90 via-slate-900/60 to-[#00476D]/80 z-[1] pointer-events-none"></div>
      ...
      <div className="flex flex-grow w-full relative z-10">
        ...
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-center p-20 relative overflow-hidden">
          ...
          <div className="relative z-10 text-white">
            ...
            <h2 className="text-xl font-semibold mb-6 text-blue-300">Recruitment Allocation Systems</h2>
              ...
              <form className="space-y-5" onSubmit={handleLoginSubmit}>
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    onChange={handleEmailChange}
                    required
                    className="w-full px-6 py-2.5 bg-slate-50 border border-slate-200 rounded-full focus:ring-2 focus:ring-[#0076b6]/20 focus:border-[#0076b6] transition-all outline-none text-slate-900 placeholder:text-slate-400 [&:-webkit-autofill]:shadow-[0_0_0_1000px_white_inset]" 
                  />
                </div>

                <div className="space-y-4">
                  <div className="space-y-2">
                    <label className="font-label-md text-[14px] font-semibold text-slate-700 ml-1" htmlFor="password">
                    ...
                    <div className="relative">
                      <input 
                        ...
                        required
                        className="w-full pl-6 pr-14 py-2.5 bg-slate-50 border border-slate-200 rounded-full focus:ring-2 focus:ring-[#0076b6]/20 focus:border-[#0076b6] transition-all outline-none text-slate-900 placeholder:text-slate-400 [&:-webkit-autofill]:shadow-[0_0_0_1000px_white_inset]" 
                      />
                      <button 
                        type="button" 
                  ...
                  <div className="text-right">
                    <button
                      ...
                      className="text-sm font-semibold text-slate-500 hover:text-[#0076b6] transition-colors"
                    >
                      Forgot Password?
                    </button>
                  </div>
                ...
                <button 
                  ...
                  className="w-full bg-gradient-to-r from-[#00476D] to-[#0076b6] text-white py-4 rounded-full font-label-md font-bold shadow-lg shadow-[#0076b6]/20 hover:shadow-[#0076b6]/40 hover:opacity-95 transition-all active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed"
                >
              ...
              {!isResetSubmitted ? (
                <>
                  <div className="flex justify-center mb-6">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#0076b6]/10 text-[#0076b6]">
                  ...
                  <form className="space-y-5" onSubmit={handleResetSubmit}>
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-[#00476D] to-[#0076b6] text-white py-4 rounded-full font-label-md text-[14px] font-bold shadow-lg shadow-[#0076b6]/20 hover:shadow-[#0076b6]/40 hover:-translate-y-0.5 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                ...
                <div className="space-y-6 text-center">
                  <div className="flex justify-center">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-slate-50 text-[#0076b6]">
