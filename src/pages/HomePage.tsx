...
//                   <span className="text-sm font-semibold text-red-300">06/09/2026(05:00 PM)</span>
//                 </div>
//                 <div>
        ...
        <section id="home" className="relative bg-gradient-to-br from-[#00476D] via-[#0076b6] to-[#00476D] text-white py-16 lg:py-24">
          <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2 text-sm">
                {/* Disabled application button with Red Tooltip */}
                <div className="relative group inline-block">
                  <button
                    disabled
                    aria-disabled="true"
                    className="w-full sm:w-auto bg-white/60 text-[#0076b6]/70 font-bold px-6 py-3.5 rounded-lg shadow-lg cursor-not-allowed transition text-center flex items-center justify-center gap-2"
                  >
                    Start Online Application <i className="fas fa-arrow-right"></i>
                  </button>
