...
// //   mandatory
// //     ? z.object({
// //         college: z.string().trim().min(1, `${label} institution name is required`),
// //         board: z.string().trim().min(1, `${label} board / university is required`),
...
// //     pwdStatus: z.string(),
// //     typeOfDisability: z.string().optional().default(''),
...
// //   duration: z.string().trim().min(1, 'Service period is required'),
...
// //     dedInstitution: z.string().trim().min(1, 'D.Ed. / D.El.Ed. institute is required'),
// //     crossDisabilityPeriod: z.string().optional().default(''),
...
// //             <video ref={videoRef} autoPlay playsInline muted className="w-full h-32 object-cover rounded-lg bg-black" />
// //             <canvas ref={canvasRef} className="hidden" />
// //             <div className="flex gap-2">
// //               <button
// //                 type="button"
// //                 onClick={capturePhoto}
// //                 className="px-4 py-1.5 rounded-md text-xs font-semibold text-white transition-colors cursor-pointer flex items-center gap-1.5 shadow-sm"
// //                 style={{ backgroundColor: theme.navy }}
// //               >
// //                 Capture
// //               </button>
...
//         (docKey) => !formData.documents[docKey as keyof typeof formData.documents] && !uploadedDocuments[docKey]
//       );
